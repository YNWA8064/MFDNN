...
model_test.conv1[0].weight.data = torch.reshape(model.conv1[0].weight.data.view(16, -1) * c1, (16, 3, 3, 3))
...
model_test.conv2[0].weight.data = torch.reshape(model.conv2[0].weight.data.view(16, -1) * c2, (16, 16, 3, 3))
...
model_test.fc1[0].weight.data = torch.reshape(model.fc1[0].weight.data.view(32*32, -1) * l1, (32*32, 16*32*32))
